...
This application was built with the help of Coder Manual bootcamp [http://codermanual.com].
...
The site can be viewed live at http://dev-match.herokuapp.com. Stripe is in test mode so no real transactions will take place. Just enter in a fake credit card number to test the 'pro' sign-up process.