...
The site can be viewed live at dev-match.herokuapp.com. Stripe is in test mode so no real transactions will take place. Just enter in a fake credit card number to test the site.